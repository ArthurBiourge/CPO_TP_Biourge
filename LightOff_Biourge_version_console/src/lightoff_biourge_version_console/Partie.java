...
public class Partie {
    ...
    public Partie(int pj_nbCoups, int p_nbLignes, int p_nbColonnes, int pg_nbCoups) {
        new GrilleDeJeu(p_nbLignes, p_nbColonnes);//on met le new ici pour pouvoir choisir les tailles de grilles
        j_nbCoups = pj_nbCoups;//nombre de cous du joueur
